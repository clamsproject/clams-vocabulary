...
for _cls in [Alignment_v1, Alignment, Annotation_v2, Annotation_v3, Annotation, BoundingBox_v1, BoundingBox_v2, BoundingBox, Chapter_v1, Chapter_v2, Chapter_v3, Chapter, Interval_v1, Interval_v2, Interval, Polygon_v1, Polygon_v2, Polygon, Region_v1, Region_v2, Region, Relation_v1, Relation_v2, Relation, Span_v1, Span_v2, Span, Thing_v1, Thing, TimeFrame_v1, TimeFrame_v2, TimeFrame_v3, TimeFrame, TimePoint_v1, TimePoint_v2, TimePoint, VideoObject_v1, VideoObject_v2, VideoObject]:
...
URI_TO_TYPE = {}
for _type in [Alignment_v1, Alignment, Annotation_v2, Annotation_v3, Annotation, BoundingBox_v1, BoundingBox_v2, BoundingBox, Chapter_v1, Chapter_v2, Chapter_v3, Chapter, Interval_v1, Interval_v2, Interval, Polygon_v1, Polygon_v2, Polygon, Region_v1, Region_v2, Region, Relation_v1, Relation_v2, Relation, Span_v1, Span_v2, Span, Thing_v1, Thing, TimeFrame_v1, TimeFrame_v2, TimeFrame_v3, TimeFrame, TimePoint_v1, TimePoint_v2, TimePoint, VideoObject_v1, VideoObject_v2, VideoObject, AudioDocument_v1, AudioDocument, Document_v1, Document, ImageDocument_v1, ImageDocument, TextDocument_v1, TextDocument, VideoDocument_v1, VideoDocument]:
