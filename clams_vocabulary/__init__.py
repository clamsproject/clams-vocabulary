...
for _cls in [Alignment_v1, Alignment, Annotation_v2, Annotation, BoundingBox_v1, BoundingBox, Chapter_v1, Chapter, Interval_v1, Interval, Polygon_v1, Polygon, Region_v1, Region, Relation_v1, Relation, Span_v1, Span, Thing_v1, Thing, TimeFrame_v1, TimeFrame, TimePoint_v1, TimePoint, VideoObject_v1, VideoObject]:
...
URI_TO_TYPE = {}
for _type in [Alignment_v1, Alignment, Annotation_v2, Annotation, BoundingBox_v1, BoundingBox, Chapter_v1, Chapter, Interval_v1, Interval, Polygon_v1, Polygon, Region_v1, Region, Relation_v1, Relation, Span_v1, Span, Thing_v1, Thing, TimeFrame_v1, TimeFrame, TimePoint_v1, TimePoint, VideoObject_v1, VideoObject, AudioDocument_v1, AudioDocument, Document_v1, Document, ImageDocument_v1, ImageDocument, TextDocument_v1, TextDocument, VideoDocument_v1, VideoDocument]:
