...
from clams_vocabulary.types.annotation.v6 import Annotation_v6


class Relation_v5(Annotation_v6):
    uri: ClassVar[str] = "http://clams.ai/vocabulary/type/Relation/v5"
    ...
    alsoKnownAs: ClassVar[list[str]] = [
        "http://mmif.clams.ai/vocabulary/Relation/v5",
    ]
