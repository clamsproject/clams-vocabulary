...
class Annotation_v6(Thing_v1, AnnotationTypesBase):
    ...
    labelset: Optional[List[str]] = Field(
        None,
        description="When an annotation object contains results of a classification task, this property is used to "
                    ...
                    "from a classifier app must have this property or <code>labelsetUri</code>. "
    ...
    labelsetUri: Optional[str] = Field(
        None,
        description="A URI to an externally defined labelset. Since the <code>labelset</code> property is a list of "
                    ...
                    "Annotations from a classifier app must have this property or <code>labelset</code>. "
                    "[/note]"
    )
    ...
    label: Optional[str] = Field(
        ...
        description="A label given to this object by classification. The value must be a simple string value of the "
                    ...
                    "<code>labelsetUri</code> properties. <br><br> For example, for the "
    ...
    classification: Optional[Dict[str, float]] = Field(
        ...
        description="A map from label values to their \"score\" numbers provided by a classifier. The score can be "
                    ...
                    "match to the values defined in the <code>labelset</code> or <code>labelsetUri</code> "
                    "properties."
    )
